...
recurse:
    ...
    # THINK: why a0?
    # ** Because he will be the argument of function square, and argument values trend to be the "a" registers
    lw a0, 0(s0)
    ...
    # Where can you assume the returned value is? A: in the a0 register
    sw a0, 0(s0)
